...
<body style="background-color: transparent;">
	<form id="myForm" name="myForm" action="sysUser!save.action"
		...
		<input type="hidden" value="<s:property value="sysUser.id"/>"
			name="sysUser.id">

		<div class="buttons">
			<input type="submit" name="subOk" value="修改" class="button" /> <input
		...
		<table class="table">
			<tr>
				...
				<td><input type="text" name="sysUser.username"
					value="<s:property value="sysUser.username"/>" dataType="Require"
					msg="用户名不能为空" class="EditBox" style="width: 90%" />
				</td>
			...
			<tr>
				...
				<td><input type="text" name="sysUser.truename"
					value="<s:property value="sysUser.truename"/>" style="width: 90%"
					dataType="Require" msg="姓名不能为空" class="EditBox" /></td>
			...
			<tr>
				...
				<td><input type="text" name="sysUser.email"
					value="<s:property value="sysUser.email"/>" style="width: 90%"
					class="EditBox" /></td>
			...
			<tr>
				...
				<td><input type="text" name="sysUser.tel" style="width: 90%"
					value="<s:property value="sysUser.tel"/>" class="EditBox" /></td>
			...
			<tr>
				...
				<td><textarea name="sysUser.other" class="MultiEditBox"
						...
						<s:property value="sysUser.other" />
					</textarea></td>
