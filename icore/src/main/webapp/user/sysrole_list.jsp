			...
			<tbody>
				...
				<tr id="middleRow">
					...
					<td id="tdContent" bgColor="#ffffff">
						...
						<h2 class="underline" id="loading">角色维护</h2>
						<div class="editor" style="width: 100%;">
							<div id="editor_left"></div>
							<div id="editor_contents">
								<ul class="editor_link">
									<li><a name="add" class="add" href="javascript:"
										onclick="window.parent.showWindow('${cxp}/user/sysrole_edit.jsp','添加角色',200,400)">添加</a>
									</li>
						...
						<table class="table" id="find_01" style="display: none">
							...
							<tr>
								<td>角色名称：<input type="text" name="name" id="name">角色描述：<input
									type="text" id="describe" name="describe"> <input
									type="button" class="button" value="查询" onclick="query()">
								</td>
							</tr>
