		...
		<table class="table">
			<tr>
				...
				<td><input type="text" name="sysUser.username"
					dataType="Require" msg="用户名不能为空" class="EditBox" style="width: 90%" />
				</td>
			...
			<tr>
				...
				<td><input type="text" name="sysUser.truename"
					style="width: 90%" dataType="Require" msg="姓名不能为空" class="EditBox" />
				</td>
			...
			<tr>
				<td>重输：</td>
				<td><input type="password" name="password2" style="width: 90%"
					dataType="Repeat" to="sysUser.password" msg="两次输入的密码不一致"
					class="EditBox" /></td>
			...
			<tr>
				<td>邮箱：</td>
				<td><input type="text" name="sysUser.email" style="width: 90%"
					class="EditBox" /></td>
