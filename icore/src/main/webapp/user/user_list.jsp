		...
		<tbody>
			...
			<tr id="middleRow">
				...
				<td id="tdContent" bgColor="#ffffff">
					...
					<form action="sysUserAction.do" method="post">
						<table class="table" id="find_01" style="display: none">



							<tr>
								<td>用户名：<input type="text" name="username">姓名：<input
									type="text" name="truename">&nbsp; 状态：<select
									name="status">
										<option value="-1">全部</option>
										<option value="0" selected>正常</option>
										<option value="1">已删除</option>
										<option value="2">已冻结</option>
								</select> <input type="button" onclick="query()" class="button"
									value="查询"></td>
							</tr>
