...
(function($) {
	...
	$.alerts = {
		...
		alert: function(message, title, okBtnText, cancelBtnText, callback) {
		...
		confirm: function(message, title, okBtnText, cancelBtnText, callback) {
		...
		prompt: function(message, value, title, okBtnText, cancelBtnText, callback) {
	...
	// Shortuct functions
	jAlert = function(message, title, okBtnText, cancelBtnText, callback) {
		$.alerts.alert(message, title, okBtnText, cancelBtnText, callback);
	}
	
	jConfirm = function(message, title, okBtnText, cancelBtnText, callback) {
		$.alerts.confirm(message, title, okBtnText, cancelBtnText, callback);
	};
		
	jPrompt = function(message, value, title, okBtnText, cancelBtnText, callback) {
		$.alerts.prompt(message, value, title, okBtnText, cancelBtnText, callback);
	};
