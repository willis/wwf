 ...
 * <p>
 * Description: <br>
 * Blowfish fish = new Blowfish(keyString); <br>
 * fish.encryptString(username + '\002' + password); <br>
 * fish.decryptString("qsWrEUU34cYLm5sqsWrE"); <br>
...
public class Blowfish {
	...
	/**
	 * 解密字符串
	 * @param sCipherText 字符串
	 * @return 解密后的字符串
	 */
	public synchronized String decryptString(String sCipherText) {
