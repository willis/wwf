...
<head>
    ...
    <script src="${cxp}/script/jquery.ajaxfileupload.js" type="text/javascript" ></script>
    ...
    <div id="header">
        <div class="headerNav">
            ...
            <ul class="nav">
                ...
                <li ><a href="http://j-ui.com/doc/dwz-user-guide.zip" target="_blank" >DWZ框架使用手册(CHM)</a> </li>
                <li><a href="${cxp }/login_out.jsp">退出</a></li>
            </ul>
                						      ...
                						      <div class="accordionContent">
                						        <ul class="tree">
                						   		<pager:eachMenu var="menu" alias="${submenu.alias}" varStatus="ind">
							                        ...
							                        <li><a href="${cxp}/v2.0${menu.link}" target="navTab" rel="${menu.alias}">${menu.name}</a></li>
							               			</s:if>
						                		</pager:eachMenu>
						                		   </ul>
						                		</div>
