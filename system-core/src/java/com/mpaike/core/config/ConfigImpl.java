...
public class ConfigImpl implements Config
{
   ...
   /**
    * @see com.ebizserve.config.Config#getConfigElement(java.lang.String)
    */
   ...
   /**
    * @see com.ebizserve.config.Config#getConfigElementValue(java.lang.String)
    */
   ...
   /**
    * @see com.ebizserve.config.Config#hasConfigElement(java.lang.String)
    */
   ...
   /**
    * @see com.ebizserve.config.Config#getConfigElements()
    */
