...
import com.mpaike.core.config.Config;
import com.mpaike.core.config.ConfigElement;
import com.mpaike.core.config.ConfigException;
import com.mpaike.core.config.ConfigLookupContext;
import com.mpaike.core.config.source.ClassPathConfigSource;
import com.mpaike.core.config.source.FileConfigSource;
import com.mpaike.core.config.source.HTTPConfigSource;
import com.mpaike.core.config.source.JarConfigSource;
import com.mpaike.core.config.source.UrlConfigSource;
import com.mpaike.core.util.base64.BaseTest;
...
public class XMLConfigServiceTest extends BaseTest
{
    ...
    public void testMissingFiles()
    {
        ...
        configFile = "classpath:wwf/missing.xml";
    ...
    {
        String configFile = "com.ebizserve/config-classpath.xml"; 
    ...
    public void xtestHTTPSource()
    {
        ...
        configFile.add("http://localhost:8080/wwf/config-http.xml");
