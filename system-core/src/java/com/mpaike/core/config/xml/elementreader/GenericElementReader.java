 ...
 */
package com.mpaike.core.config.xml.elementreader;
...
import com.mpaike.core.config.element.GenericConfigElement;
import com.mpaike.core.config.xml.XMLConfigService.PropertyConfigurer;
...
public class GenericElementReader implements ConfigElementReader
{
   ...
   /**
    * @see com.ebizserve.config.xml.elementreader.ConfigElementReader#parse(org.dom4j.Element)
    */
