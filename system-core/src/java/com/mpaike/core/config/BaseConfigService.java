...
public abstract class BaseConfigService extends AbstractLifecycleBean implements ConfigService
{
    ...
    public List<ConfigDeployment> initConfig()
    {
        ...
        addEvaluator(stringCompare, createEvaluator(stringCompare, "com.mpaike.core.config.evaluator.StringEvaluator"));
        String objectType = "object-type";
        addEvaluator(objectType, createEvaluator(objectType, "com.mpaike.core.config.evaluator.ObjectTypeEvaluator"));
    ...
    /**
     * @see com.mpaike.core.config.ConfigService#getConfig(java.lang.Object)
     */
    ...
    /**
     * @see com.mpaike.core.config.ConfigService#getConfig(java.lang.Object, com.mpaike.core.config.ConfigLookupContext)
     */
    ...
    /**
     * @see com.mpaike.core.config.ConfigService#getGlobalConfig()
     */
    ...
    /**
     * @see com.mpaike.core.config.ConfigService#appendConfig(com.ebizserve.config.ConfigSource)
     */
