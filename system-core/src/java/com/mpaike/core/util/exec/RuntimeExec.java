 ...
 */
package com.mpaike.core.util.exec;
...
public class RuntimeExec
{
    ...
    public void setCommandMap(Map<String, String> commandsByOS)
    {
        ...
        logger.warn(
        		...
        		" use 'commandsAndArguments' instead.  See https://issues.42y.net/jira/browse/ETHREEOH-579.");
    ...
    public ExecutionResult execute(Map<String, String> properties)
    {
        ...
        if (command == null)
        {
            throw new WWFRuntimeException("Runtime command has not been set: \n" + this);
        }
    ...
    public static class InputStreamReaderThread extends Thread
    {
        ...
        public synchronized void run()
        {
            ...
            {
                throw new WWFRuntimeException("Unable to read stream", e);
            }
            finally
            {
