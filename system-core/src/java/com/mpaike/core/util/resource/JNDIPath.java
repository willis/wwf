...
*  method:  com.ebizserve.jndi.AVMFileDirContext.getAVMFileDirMountPoint()
*
*   <pre>
*
*   EXAMPLE:
...
*        mount_point == /media/wwf/cifs/v 
*        jndi_path   == /media/wwf/cifs/v/mysite/VERSION/v-1/DATA/www/avm_webapps/ROOT
*
...
*        com.ebizserve.filesys.avm.AVMPath sometime soon.
*/
import java.io.File;
