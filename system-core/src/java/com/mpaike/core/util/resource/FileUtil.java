...
import com.mpaike.core.util.filter.AllFileFilter;
import com.mpaike.core.util.net.MimeTypeUtil;
...
public class FileUtil {
	 ...
	 * @throws Exception
	 */
	public static boolean valadateFile(File file, String[] exts)
			throws Exception {
		boolean flag = false;
		if (file != null) {
			String ext = MimeTypeUtil.getExtension(file.getName());
			if (ext == null) {
				return false;
			}
	...
	public static void Zip(String fileName,String zipfile,File file) {
		try {
