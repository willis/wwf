...
*  Software ("FLOSS") applications as described in WWF's FLOSS exception.
*  You should have received a copy of the text describing the FLOSS exception,
*  and it is also available here:   http://www.42y.net/legal/licensing
*  
*  
*  Author  
...
import com.mpaike.core.util.GUID;
 ...
 *   "127-0-0-1.ip.wwfdemo.net" and  "*.127-0-0-1.ip.wwfdemo.net"
 *   resolve to 127.0.0.1, so effectively "127-0-0-1.ip.wwfdemo.net"
