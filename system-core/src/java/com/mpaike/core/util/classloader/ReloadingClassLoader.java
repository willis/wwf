    ...
    public ReloadingClassLoader(final ClassLoader pParent) {
        ...
        try {
            if (root != null) {
                ...
                throw new WWFException("Unable to start the reloadable class loader, consider setting 'struts.convention.classes.reload' to false");
            }
        } catch (URISyntaxException e) {
            throw new WWFException("Unable to start the reloadable class loader, consider setting 'struts.convention.classes.reload' to false", e);
