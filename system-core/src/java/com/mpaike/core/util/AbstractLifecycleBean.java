...
/**
 * Abstract helper for assisting the bootstrap and termination of WWF Components
 */
public abstract class AbstractLifecycleBean implements ApplicationListener, ApplicationContextAware
{
    ...
    /**
     * Callback for initialising Component on first startup of WWF Server
     * 
     * @param event
     */
    ...
    /**
     * Callback for terminating Component on shutdown of WWF Server
     * 
     * @param event
     */
