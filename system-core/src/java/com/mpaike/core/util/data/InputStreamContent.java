...
import com.mpaike.core.util.Content;
...
public class InputStreamContent implements Content, Serializable
{
    ...
    /* (non-Javadoc)
     * @see com.ebizserve.util.Content#getContent()
     */
    ...
    /* (non-Javadoc)
     * @see com.ebizserve.util.Content#getInputStream()
     */
    ...
    /* (non-Javadoc)
     * @see com.ebizserve.util.Content#getSize()
     */
    public long getSize()
    {
        return -1;
    ...
    /* (non-Javadoc)
     * @see com.ebizserve.util.Content#getMimetype()
     */
    ...
    /* (non-Javadoc)
     * @see com.ebizserve.util.Content#getEncoding()
     */
