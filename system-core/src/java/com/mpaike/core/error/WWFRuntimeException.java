...
/**
 * I18n'ed runtime exception thrown by WWF code.
 */
public class WWFRuntimeException extends RuntimeException
{
    /**
     * Serial version UUID
     */
     ...
     */
    public static WWFRuntimeException create(String msgId, Object ...objects)
    {
        return new WWFRuntimeException(msgId, objects);
    }

    /**
     * Helper factory method making use of variable argument numbers
     */
    public static WWFRuntimeException create(Throwable cause, String msgId, Object ...objects)
    {
        return new WWFRuntimeException(msgId, objects, cause);
    }
    ...
    public static RuntimeException makeRuntimeException(Throwable e, String msgId, Object ...objects)
    {
        ...
        // Convert it
        return WWFRuntimeException.create(e, msgId, objects);
    }
     ...
     */
    public WWFRuntimeException(String msgId)
    {
     ...
     */
    public WWFRuntimeException(String msgId, Object[] msgParams)
    {
     ...
     */
    public WWFRuntimeException(String msgId, Throwable cause)
    {
     ...
     * @param cause         the exception cause
     */
    public WWFRuntimeException(String msgId, Object[] msgParams, Throwable cause)
    {
