...
function CLASS_LIANDONG(array) {
	...
	this.subSelectChange = function(selectName1, selectName2, cbxName) {
	...
	this.firstSelectChange = function(indexName, selectName, cbxName) {
		this.obj = document.getElementById(selectName);
		this.indexName = indexName;
		this.optionChange(this.indexName, this.obj.id, cbxName)
	}

	// indexName指选中项,selectName指select的ID
	this.optionChange = function(indexName, selectName, cbxName) {
		...
		for (var i = 0; i < this.array.length; i++) {
			...
			if (this.array[i][1] == indexName) {
				...
				obj1.options[obj1.length] = new Option(this.array[i][2],
						this.array[i][0]);
				if (cbxName == obj1.options[obj1.length - 1].value) {
...
array[31] = new Array("东城区", "北京市", "东城区");
array[32] = new Array("西城区", "北京市", "西城区");
array[33] = new Array("崇文区", "北京市", "崇文区");
array[2698] = new Array("宣武区", "北京市", "宣武区");
array[2699] = new Array("朝阳区", "北京市", "朝阳区");
array[2700] = new Array("丰台区", "北京市", "丰台区");
array[2701] = new Array("石景山区", "北京市", "石景山区");
array[2702] = new Array("海淀区", "北京市", "海淀区");
array[2703] = new Array("门头沟区", "北京市", "门头沟区");
array[2704] = new Array("房山区", "北京市", "房山区");
array[2705] = new Array("通州区", "北京市", "通州区");
array[2706] = new Array("顺义区", "北京市", "顺义区");
array[2707] = new Array("昌平区", "北京市", "昌平区");
array[2708] = new Array("大兴区", "北京市", "大兴区");
array[2709] = new Array("怀柔区", "北京市", "怀柔区");
array[2710] = new Array("平谷区", "北京市", "平谷区");
array[2711] = new Array("密云县", "北京市", "密云县");
array[2712] = new Array("延庆县", "北京市", "延庆县");
...
array[326] = new Array("荔湾区", "广州", "荔湾区");
array[327] = new Array("越秀区", "广州", "越秀区");
array[328] = new Array("海珠区", "广州", "海珠区");
array[2744] = new Array("天河区", "广州", "天河区");
array[2745] = new Array("白云区", "广州", "白云区");
array[2746] = new Array("黄埔区", "广州", "黄埔区");
array[2747] = new Array("番禺区", "广州", "番禺区");
array[2748] = new Array("花都区", "广州", "花都区");
array[2749] = new Array("南沙区", "广州", "南沙区");
array[2750] = new Array("萝岗区", "广州", "萝岗区");
array[2751] = new Array("萝岗区", "广州", "萝岗区");
array[2752] = new Array("从化市", "广州", "从化市");
array[2753] = new Array("增城市", "广州", "增城市");
...
array[388] = new Array("罗湖区", "深圳", "罗湖区");
array[2754] = new Array("福田区", "深圳", "福田区");
array[2755] = new Array("南山区", "深圳", "南山区");
array[2756] = new Array("宝安区", "深圳", "宝安区");
array[2757] = new Array("龙岗区", "深圳", "龙岗区");
array[2758] = new Array("盐田区", "深圳", "盐田区");
...
array[2080] = new Array("黄浦区", "上海市", "黄浦区");
array[2081] = new Array("卢湾区", "上海市", "卢湾区");
array[2727] = new Array("徐汇区", "上海市", "徐汇区");
array[2728] = new Array("长宁区", "上海市", "长宁区");
array[2729] = new Array("静安区", "上海市", "静安区");
array[2730] = new Array("普陀区", "上海市", "普陀区");
array[2731] = new Array("闸北区", "上海市", "闸北区");
array[2732] = new Array("虹口区", "上海市", "虹口区");
array[2733] = new Array("杨浦区", "上海市", "杨浦区");
array[2734] = new Array("闵行区", "上海市", "闵行区");
array[2735] = new Array("宝山区", "上海市", "宝山区");
array[2736] = new Array("嘉定区", "上海市", "嘉定区");
array[2737] = new Array("浦东新区", "上海市", "浦东新区");
array[2738] = new Array("金山区", "上海市", "金山区");
array[2739] = new Array("松江区", "上海市", "松江区");
array[2740] = new Array("青浦区", "上海市", "青浦区");
array[2741] = new Array("南汇区", "上海市", "南汇区");
array[2742] = new Array("奉贤区", "上海市", "奉贤区");
array[2743] = new Array("崇明县", "上海市", "崇明县");
...
array[2260] = new Array("和平区", "天津市", "和平区");
array[2261] = new Array("河东区", "天津市", "河东区");
array[2262] = new Array("河西区", "天津市", "河西区");
array[2263] = new Array("南开区", "天津市", "南开区");
array[2713] = new Array("河北区", "天津市", "河北区");
array[2714] = new Array("红桥区", "天津市", "红桥区");
array[2715] = new Array("塘沽区", "天津市", "塘沽区");
array[2716] = new Array("汉沽区", "天津市", "汉沽区");
array[2717] = new Array("大港区", "天津市", "大港区");
array[2718] = new Array("东丽区", "天津市", "东丽区");
array[2719] = new Array("西青区", "天津市", "西青区");
array[2720] = new Array("津南区", "天津市", "津南区");
array[2721] = new Array("北辰区", "天津市", "北辰区");
array[2722] = new Array("武清区", "天津市", "武清区");
array[2723] = new Array("宝坻区", "天津市", "宝坻区");
array[2724] = new Array("蓟县", "天津市", "蓟县");
array[2725] = new Array("静海县", "天津市", "静海县");
array[2726] = new Array("宁河县", "天津市", "宁河县");
