...
<head>
	...
	<link rel="stylesheet" href="js/tags.css" type="text/css" charset="utf-8">
	<style type="text/css">
	body {
		font-size: 12px;
	}
...
<body>
  ...
  <script src="js/jquery.address-1.3.1.min.js"></script> 
  ...
  <div id="intro"> 
    ...
    <p>It takes one of the central good ideas of GraphViz – the <code><a target="_blank" href="http://graphviz.org/doc/info/lang.html">.dot</a></code> 
       ...
       and brevity of syntax. Remember, <a target="_blank" href="http://www.jwz.org/doc/worse-is-better.html">worse is better</a> these days.</p> 
  ...
  <div id="halfviz"> 
    ...
    <div id="editor"> 
      <div class="io"> 
        <div class="ctrl"><a href="#" class="new">clear</a>|<a class="save"></a><a class="examples" href="#">examples <span></span></a></div> 
        <ul class="dialog"></ul> 
      </div> 
  ...
  <div id="dashboard"> 
    ...
    <a href="#" class="help" title="syntax reference"></a> 
    <ul class="controls"> 
    ...
    <!-- <a href="#" class="about">about halfviz</a> --> 
  </div> 
