			 ...
			 function ajaxAddTag(tags){
		  	...
		  	function formTag(callback) {
		  		...
		  		if(getNotTags()===''){
					...
					parent.jConfirm('"'+getNotTags()+'" 不存在，需做以下的操作<br/><br/>提交给管理员进行标签添加，此文章保存为草稿，如忽略可跳过在存在的标签文章进行待选库', '确定对话框', function(r) {
						if(r==true){
		...
		<table width="100%" height="100%">
			<tr>
				...
				<td width="250" valign="top">
					...
					<iframe id="relationFrame" src="geneaction!formTag.action" scrolling="auto" frameborder="0" width="98%" height="100%"></iframe>	
				</td>
			</tr>
		</table>
</body>
