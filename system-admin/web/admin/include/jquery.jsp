...
<script type="text/javascript" src="${cxp}/js/jquery/plugin/block/jquery.blockUI.packed.js"></script>
...
<script type="text/javascript" src="${cxp}/js/jquery/plugin/alert/jquery.alerts.packed.js"></script>
