...
SWFUpload.prototype.init = function(settings) {
	...
	this.addSetting("flash_path", settings["flash_path"], "js/SWFUpload/SWFUpload.swf");								// Path to flash-file
	...
	this.addSetting("post_params",settings["post_params"],"0");
...
SWFUpload.prototype._getFlashVars = function() {
	...
	sb.append("&post_params=" + this.getSetting("post_params"));
...
SWFUpload.prototype.loadUI = function() {
	...
	if(this.getSetting("target") != "" && this.getSetting("target") != "fileinputs") {
		...
		var browselink = document.getElementById(this.getSetting("browse_link_ID"));
		...
		if(this.getSetting("auto_upload") == false) {
			// Create the link for uploading
			var uploadlink = document.getElementById(this.getSetting("upload_link_ID"));		
