...
public interface ICommonDao {
	 ...
	 * hql批量操作
	 * 示例 
	 * simpleDao.bulkUpdate("delete from SystemLog where id in("+ids+")");
	 * @param 
	 * @return void
	 **/
	public void  bulkUpdate(String s);
	
	/**
	 * hql批量操作
	 * 示例 
	 * simpleDao.bulkUpdate("update SysUser u set u.password=? where u.id=?",new Object[]{MD5.toMD5(password),id[i]});
	 * @param 
	 * @return void
	 **/
	public void  bulkUpdate(String statement, Object[] o);
}
